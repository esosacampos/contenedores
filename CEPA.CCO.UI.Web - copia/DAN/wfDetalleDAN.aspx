...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="EmployeesUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="IdDeta"
                ...
                data-page-size="5" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound" OnRowCreated="onRowCreate"  PagerStyle-CssClass="pagination pagination-centered hide-if-no-paging">
                <Columns>
    ...
    <div class="form-group" style="margin-left: 15px;">
        <label for="texto">
            ...
            Retiro Directo y si es <b>T</b> es Trasbordo.</label>
    </div>
    <hr />
    <nav>
        <ul class="pager">
