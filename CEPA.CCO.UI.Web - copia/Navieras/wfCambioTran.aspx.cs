            ...
            try
            {
                ...
                if (_lit.Count > 0)
                {
                    ...
                    {                        
                        ...
                        int _resultado = Convert.ToInt32(DetaNavieraDAL.ActualizarCambiosId(DBComun.Estado.verdadero, item.IdDeta, item.s_observaciones, User.Identity.Name, bc_cambio, dc, da));
