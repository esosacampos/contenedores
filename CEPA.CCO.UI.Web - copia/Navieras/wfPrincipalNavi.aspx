...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>
        Lista de Buques Anunciados Importación</h2>
    <hr />
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="footable"
                DataKeyNames="c_buque" OnRowDataBound="GridView1_RowDataBound" data-filter="#filter" Style="max-width: 98%;
                margin-left: 15px;" ShowFooter="true" data-page-size="5" OnRowCreated="onRowCreate">
                <Columns>
