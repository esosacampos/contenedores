...
namespace CEPA.CCO.UI.Web
{
    ...
    /// </summary>
    public class FileUploadHandlerEx : IHttpHandler, System.Web.SessionState.IRequiresSessionState 
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                context.Response.Write("<script>bootbox.alert('" + ex.Message + "');</script>");
