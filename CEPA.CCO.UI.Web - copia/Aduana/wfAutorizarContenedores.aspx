<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="wfAutorizarContenedores.aspx.cs" Inherits="CEPA.CCO.UI.Web.Aduana.wfAutorizarContenedores" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="style1">
        ...
        <tr>
            <td class="style10">
                Num. Manifiesto</td>
            <td class="style11">
                <asp:Label ID="n_manifiesto" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <td class="style10">
    ...
    <div style="float: left; width: 45%">
        <asp:Button ID="btnCargar" runat="server" Text="Autorizar" 
