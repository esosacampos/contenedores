...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>
        Manifiestos Pendientes De Validación</h2>
    <hr />
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="footable"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="num_manif" HeaderText="No. MANIFIESTO"></asp:BoundField>
                    ...
                    <asp:BoundField DataField="IdDoc" HeaderText="ID Doc"></asp:BoundField>
    ...
    <script type="text/javascript">
        ...
        function ValidacionCheck(btn) {
            ...
            for (var row = 1; row < gridview.rows.length; row++) {
                ...
                if (checkbox.checked) {
                    var manifiesto = gridview.rows[row].cells[1].innerText;
                    ...
                    if (btn == "Omitir") {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "wfConsultaBuques.aspx/RevisarManif",
                            data: params,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (result) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "wfConsultaBuques.aspx/GenerarListadoExcel",
                            data: params1,
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            success: function (result) {
                ...
                if (contador == 0 && btn == "Button") {
                    bootbox.alert("Debe seleccionar manifiesto a autorizar");
                }
            }
        }
