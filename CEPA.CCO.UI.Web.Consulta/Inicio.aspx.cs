    ...
    public partial class Inicio : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                List<UsuarioContra> _lista = UsuarioDAL.UserContratista(DBComun.Estado.verdadero, Convert.ToInt32(inputTxtandPassw.Value));
                ...
                System.Web.Security.FormsAuthenticationTicket AuthTicket = new System.Web.Security.FormsAuthenticationTicket(1, nombreC, DateTime.Now, DateTime.Now.AddMinutes(60), false, inputTxtandPassw.Value);
