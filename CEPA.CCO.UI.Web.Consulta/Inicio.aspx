...
<head>
    ...
    <link rel="icon" href="images/26270.png">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <title>CEPA - Contenedores Movil</title>
    <!-- Bootstrap -->
...
<body>
        ...
        <div class="col-md-12">
            ...
            <div class="col-md-4" id="login">
                <div class="form-signin" role="form" style="margin: 10px;">
                    ...
                    <input id="inputTxtandPassw" type="password" class="form-control" autocomplete="off" placeholder="Código de Marcación" runat="server">                    
    ...
    <div id="nebaris">
        © 2014 CEPA / Puerto de Acajutla, El Salvador v2.0 para Soporte Técnico <a href="#">
