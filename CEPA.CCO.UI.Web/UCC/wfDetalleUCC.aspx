<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="wfDetalleUCC.aspx.cs" Inherits="CEPA.CCO.UI.Web.UCC.wfDetalleUCC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Retener Contenedores UCC</h2>
    <hr />
    ...
    <script type="text/javascript">
        ...
        function Check_Click(objRef) {
            ...
            if (objRef.checked) {
                ...
                $.ajax({
                    type: "POST",
                    url: "wfDetalleUCC.aspx/RetenValid",
                    data: params2,
