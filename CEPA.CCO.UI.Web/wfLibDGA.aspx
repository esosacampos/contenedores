   <%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="wfLibDGA.aspx.cs" Inherits="CEPA.CCO.UI.Web.wfLibDGA" EnableEventValidation="false" %>
        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="f_retenidoc,f_recep_patioc,c_navi,c_tipo_doc,c_manifiesto"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="f_retenidoc" HeaderText="fecha"></asp:BoundField>
