...
{
    public partial class wfUCCEstadistica : System.Web.UI.Page
    {
        ...
        protected void btnBuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (a_valor >= 2018)
                {
                    GridView1.DataSource = DanEstadisticaDAL.ObtenerEstadistica(txtBuscar.Text, "216");
                    GridView1.DataBind();
                    ...
                    throw new Exception("Debe indicar el año a consultar pero no puede ser menor de 2018");
            }
            catch (Exception ex)
            {
