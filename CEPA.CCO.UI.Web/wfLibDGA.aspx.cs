...
{
    public partial class wfLibDGA : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ddlYear.DataSource = TipoRevisionesDAL.Year("DGA");
        ...
        private void Guardar()
        {
            ...
            try
            {
                ...
                SeleccionManager.LiberadosDGA(GridView1);
                ...
                if (_lit.Count > 0)
                {
                    ...
                    foreach (DetaNaviera item in _lit)
                    {
                        ...
                        _resultado = Convert.ToInt32(DetaNavieraDAL.ActualizarDGAL(DBComun.Estado.verdadero, item.IdDeta,  User.Identity.Name));
        ...
        public void EnviarCorreo(List<DetaNaviera> pContenedores, string d_buque, int pValor, int pCantidad, string c_cliente, string nviaje, string nmani1, string c_naviera, string c_prefijo)
        {
            ...
            try
            {
                ...
                Html += "MÓDULO : LISTADO DE CONTENEDORES LIBERADOS POR ADUANA  <br />";
                Html += "TIPO DE MENSAJE : NOTIFICACIÓN DE CONTENEDORES LIBERADOS POR ADUANA <br /><br />";
                ...
                Html += "Los siguientes contenedores fueron liberados por la ADUANA para su revisión se detallan a continuación : ";
                Html += "<br /><br/>";
