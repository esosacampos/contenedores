<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="wfAnexosExport.aspx.cs" Inherits="CEPA.CCO.UI.Web.Navieras.wfAnexosExport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Anexos de Estadía De Contenedores De Exportación
    </h2>
    <br />
            ...
            <div role="form">
                <div class="form-inline">
                    ...
                    <div class="form-group" style="width: 40%;">
                        <asp:TextBox ID="txtBuscar" runat="server" CssClass="form-control" Width="100%" Text="04FAC0000000000XXXXX" autocomplete="off"></asp:TextBox>
                    </div>
                    <div class="form-group">
