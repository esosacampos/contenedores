    ...
    public partial class wfPrincipalNavi : System.Web.UI.Page
    {
        ...
        private void Cargar()
        {
           ...
           List<DocBuque> pList = new List<DocBuque>();
            ...
            pList = (from a in DocBuqueLINQ.ObtenerBuqueDoc(Session["c_naviera"].ToString(), Session["c_usuario"].ToString())
                     join b in EncaNavieraDAL.GetNavieras(DBComun.Estado.verdadero) on a.c_cliente equals b.c_naviera
                     select new DocBuque
                     {
                         ...
                         CantArchivo = a.CantArchivo,
                         CantRemo = a.CantRemo,
                         c_prefijo = b.d_naviera_p,
                         CantExport = a.CantExport
                     }).ToList();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                c_imo = e.Row.Cells[1].Text;
                c_llegada = e.Row.Cells[2].Text;
        ...
        protected void onRowCreate(object sender, GridViewRowEventArgs e)
        {
            ...
            {
                int colSpan = e.Row.Cells.Count + 5;
