<%@ Page Title="Sustituir Archivos Exportacion" Language="C#" MasterPageFile="~/Principal.Master"
    AutoEventWireup="true" CodeBehind="wfSustituirArchEx.aspx.cs" Inherits="CEPA.CCO.UI.Web.wfSustituirArchEx" %>
                ...
                if (error == 0) {
                    ...
                    if (confirm("Esta opción eliminara el contenido del documento seleccionado ¿Desea continuar con la sustitución del archivo : " + listbox.options[listbox.selectedIndex].text + "?")) {
                        ...
                        $.FileDialog({ multiple: true }).on('files.bs.filedialog', function (ev) {
                            ...
                            $.ajax({
                                url: '<%= ResolveClientUrl("~/FileExport.ashx") %>' + '?d_buque=' + buque + '&c_imo=' + c_imo + '&c_llegada=' + c_llegada + '&f_llegada=' + f_llegada + '&arch_susti=' + arch_susti + '&susti=1' + "&aduana=0" + '&proceso=1' + '&c_naviera=' + c_naviera + '&c_iso_navi=' + c_iso_navi,
                                type: "POST",
                                data: data,
                                contentType: false,
                                processData: false,
