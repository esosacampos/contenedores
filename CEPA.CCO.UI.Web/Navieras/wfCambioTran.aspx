...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>Cambio Condicion Contenedores</h2>
    <hr />
    ...
    <asp:UpdatePanel ID="EmployeesUpdatePanel" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="c_correlativo"
                data-filter="#filter" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="A CONECTAR">
                        <ItemTemplate>
    ...
    <br />
    <br />
    <asp:Label ID="Label2" runat="server" Text="* Los contenedores de tipo REEF deben indicar a conectar o no si queda en blanco se indicara que NO SE CONECTARA"
        Style="color: #FF0000; font-weight: 700"></asp:Label>
    <br />
    <br />
    <nav>
