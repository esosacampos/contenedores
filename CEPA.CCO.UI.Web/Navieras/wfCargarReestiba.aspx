<%@ Page Title="Cargar Archivos" Language="C#" MasterPageFile="~/Principal.Master"
    AutoEventWireup="true" CodeBehind="wfCargarReestiba.aspx.cs" Inherits="CEPA.CCO.UI.Web.wfCargarReestiba" %>
        ...
        $(document).ready(function () {
            $("#open_btn").click(function () {
                $.FileDialog({ multiple: true }).on('files.bs.filedialog', function (ev) {
                    ...
                    $.ajax({
                        url: '<%= ResolveClientUrl("~/FileUploadHandlerRees.ashx") %>' + '?d_buque=' + buque + '&c_imo=' + c_imo + '&c_llegada=' + c_llegada + '&f_llegada=' + f_llegada + '&proceso=1',
                        type: "POST",
                        data: data,
                        contentType: false,
                        processData: false,
