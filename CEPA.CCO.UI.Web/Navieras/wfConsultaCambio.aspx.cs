...
{
    public partial class wfConsultaCambio : System.Web.UI.Page
    {
        ...
        private void Cargar()
        {
            ...
            GridView1.DataSource = DocBuqueLINQ.ObtenerCambios(DBComun.Estado.verdadero, Session["c_naviera"].ToString());
            GridView1.DataBind();
