        ...
        <ContentTemplate>
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="f_retenidoc,f_recep_patioc,c_navi,c_tipo_doc,c_manifiesto"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="f_tramite_s" HeaderText="F. INICIO TRAMITE" ItemStyle-CssClass="f_trami"></asp:BoundField>
                    <%--<asp:TemplateField HeaderText="F. INICIO TRAMITE">
                        <ItemTemplate>
                           <asp:Label ID="txtDOB" runat="server" class="form-control label-ft" Text='<%# Eval("f_tramite_s") %>'></asp:Label>                              
                        </ItemTemplate>
                    </asp:TemplateField>--%>
                    ...
                    <asp:TemplateField HeaderText="REVISION">
                        <ItemTemplate>
                            <asp:DropDownList ID="ddlRevision" runat="server" class="selectpicker show-tick seleccion" onchange="changeInput(this)" data-style="btn-primary">
                            </asp:DropDownList>
...
const { data } = require("jquery");
        ...
        function pageLoad() {
            $(document).ready(function () {
                ...
                $('#datetimepicker1.input-group.date.now').datetimepicker({
                    locale: 'es',
                    format: 'DD/MM/YYYY HH:mm'
                });

                $('#datetimepicker2.input-group.date.other').datetimepicker({
                    locale: 'es',
                    format: 'DD/MM/YYYY HH:mm',
                    maxDate: moment(),
                    useCurrent: false
