    ...
    public partial class wfGenerarOficio : System.Web.UI.Page
    {
        ...
        protected void brnReporte_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    throw new Exception("Indicar año de oficio en formato 4 digitos Ej. 2015");
                }
                ...
                ReportDataSource datasource = new
                  ...
                  DocBuqueLINQ.ObtenerOficioReport(TextBox1.Text, a_folio));

                ReportViewer1.LocalReport.DataSources.Clear();
                ReportViewer1.LocalReport.DataSources.Add(datasource);
                if (DocBuqueLINQ.ObtenerOficioReport(TextBox1.Text, a_folio).Count == 0)
                {
