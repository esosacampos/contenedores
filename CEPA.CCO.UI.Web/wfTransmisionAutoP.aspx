<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
    CodeBehind="wfTransmisionAutoP.aspx.cs" Inherits="CEPA.CCO.UI.Web.wfTransmisionAutoP" %>
        ...
        <ContentTemplate>
            ...
            <asp:GridView ID="GridView1" CssClass="footable" runat="server" AutoGenerateColumns="False" DataKeyNames="c_llegada"
                ...
                <Columns>
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="Link1" runat="server" CssClass="btn btn-info btn xs" NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"c_llegada", "wfTransmisionAutoD.aspx?c_llegada={0}") %>'
