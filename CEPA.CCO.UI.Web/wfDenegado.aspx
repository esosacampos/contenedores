<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfDenegado.aspx.cs" Inherits="CEPA.CCO.UI.Web.wfDenegado" %>
        ...
        <div class="container-fluid text-left">
            <div class="row content">
                ...
                <div class="col-sm-10 text-left principal">
                    <hr>
                    <div id="ImagenAcceso">
                        <img src="CSS/Img/construccion.png" style="position: absolute; left: 51%;">
                        <br>
                    </div>
                    ...
                    <div style="width: 55%;">
                        ...
                        <div class="alert alert-dismissable" role="alert">
                            <p>
                                <strong>Advertencia:</strong> Usted está intentado visitar una página a la cual no tiene permisos.
                            </p>
                            <br />
                            <p>
