(function ($, w, undefined) {
    ...
    function Paginate() {
        ...
        p.setupPaging = function () {
            ...
            var mensaje = p.fillPage(ft, $tbody, ft.pageInfo.currentPage);
            $('.label-default.pie').html(mensaje);
            //$('#pieMensaje').html(mensaje);
        };
        ...
        p.paginate = function (ft, newPage) {
            ...
            if (info.currentPage !== newPage) {
                ...
                var mensaje = p.fillPage(ft, $tbody, newPage);
        ...
        p.fillPage = function (ft, tbody, pageNumber) {
            ...
            if (filtered == false) {
                contar = tbody[0].childElementCount;

                var actual = ft.pageInfo.currentPage;
                ...
                var x1 = (actual - 1) * ft.pageInfo.pageSize + 1
                if (x1 == 0)
                    x1 = 1;

                var y1 = x1 + ft.pageInfo.pageSize - 1

                if (y1 > contar)
                    y1 = contar;

                mensaje = "Mostrando del " + x1 + " al " + y1 + " de " + contar + " filas encontradas";
            }
            else
            {
                var actual = ft.pageInfo.currentPage;
