<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="wfPrinciExport.aspx.cs" Inherits="CEPA.CCO.UI.Web.Aduana.wfPrinciExport" %>
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="footable"
                ...
                <Columns>
                   ...
                   <%-- <asp:TemplateField HeaderText="AUTORIZAR TODOS">
                    ...
                    <asp:TemplateField>
                        <ItemTemplate>
                            <asp:HyperLink ID="Link2" runat="server" CssClass="btn btn-primary btn xs" NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"IdReg", "/Aduana/wfAutoExport.aspx?IdReg={0}") %>'
