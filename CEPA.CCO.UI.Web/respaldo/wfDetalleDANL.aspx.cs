        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                try
                {
                    ...
                    ddlYear.DataSource = TipoRevisionesDAL.Year("DAN");
            ...
            try
            {
                ...
                if (_lit.Count > 0)
                {
                    ...
                    foreach (DetaNaviera item in _lit)
                    {
                        ...
                        if (item.t_revision > 0 && item.f_revision != null && item.s_marchamo != null)
                        {
                        ...
                        {
                            throw new Exception("Debe indicar fecha de revision y/o tipo de revision y/o número de marchamo");
                        }
