            ...
            try
            {
                ...
                if (_lit.Count > 0)
                {
                    ...
                    if (valores > 0)
                    {
                        ...
                        Correlativo = Convert.ToInt32(DetaNavieraDAL.ObtenerCorrelativo(c_imo.Text, c_llegada.Text, c_naviera)) + 1;
                        ...
                        List<ArchivoAduana> _listaAOrdenar = DetaNavieraDAL.ObtenerResultado(Convert.ToInt32(Request.QueryString["IdReg"]), _rango, Correlativo - 1);
