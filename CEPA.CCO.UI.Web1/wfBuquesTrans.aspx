    ...
    <script type="text/javascript">
        ...
        function abrirModal(pagina, idreg) {
            ...
            if (vReturnValue != null && vReturnValue == true) {
                ...
                window.location = "wfDetalleDAN.aspx?IdReg=" + idreg;
                return vReturnValue
            }
            else {
                return false;
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <h2>
        Lista de Buques Autorizados</h2>
    <br />
    <br>
        ...
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="Panel1" Width="100%" ScrollBars="vertical" Height="300px">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%"
                    class="filtrar" DataKeyNames="IdReg" Font-Names="Segoe UI Light" >
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:HyperLink ID="Link1" runat="server" NavigateUrl='<%# DataBinder.Eval(Container.DataItem,"IdReg", "wfConsultaTrans.aspx?IdReg={0}") %>'
                                    Text="Consultar" ForeColor="Blue"></asp:HyperLink>
                            </ItemTemplate>
