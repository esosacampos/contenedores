<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfAddTipo.aspx.cs" Inherits="CEPA.CCO.UI.Web.DAN.wfAddTipo" EnableEventValidation="false" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <link href="../CSS/CEPA_CSS.css" rel="stylesheet" type="text/css" />
    <title>Tipos de Revision</title>
            ...
            <ContentTemplate>
                <table align="center" style="font-size: 12px; text-transform: uppercase; font-family: Verdana;"
                    ...
                    <tr>
                        ...
                        <td class="style11">
                            <asp:TextBox ID="txtClave" runat="server" Width="320px" 
                    ...
                    <tr>
                        ...
                        <td align="center" class="style11">
                            <asp:TextBox ID="txtTipo" runat="server" Width="320px" 
                                Style="text-transform: uppercase;"></asp:TextBox>
