...
namespace CEPA.Tareas.UI.ASP.Controls
{
    public partial class MultiFileUpload : System.Web.UI.UserControl
    {
        public HttpFileCollection _fcol;
        public HttpPostedFile _postedF;
        public ListItem _listaI = new ListItem();
        public ListBox _listaP = new ListBox();
        public List<string> _listaS = new List<string>();
        private int __MaxSize = 4096; // Límite predeterminado de la subida, en bytes.
        private bool subidos = false;
        #region Propiedades
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            upldFile_0.ViewStateMode = System.Web.UI.ViewStateMode.Enabled;
            upldFile_0.EnableViewState = true;
        ...
        protected void btnUpload_Click(object sender, EventArgs e)
        {
            if (subidos == false)
            {
                ...
                lblInfo.Text = "Ya se cargo archivo para este buque";
        }
                    ...
                    try
                    {
                        ...
                        for (int i = 0; i < _fcol.Count; i++)
                        {
                            ...
                            if (_postedF.ContentLength > 0)
                            {
                                ...
                                HttpContext.Current.Session["archivo"] = upldFile_0.FileName;                              
                                _postedF.SaveAs(_f2save);
                                                
                                HttpContext.Current.Session["rut"] = _dirPath;
                                HttpContext.Current.Session["ruta"] = _f2save.ToString();
                                _listaS.Add(_f2save);
        ...
        /// <returns></returns>
        public bool ValidarExtensiones(HttpFileCollection p_Fcol)
        {
